...
create table expediente_local (
    ...
    fecha_inicio_expediente DATETIME default now(),
    otros varchar (100),
    cedula varchar (10) not null,
    FOREIGN KEY (cedula) references cliente(cedula)
);
...
CREATE TABLE instruccion_fiscal (
    ...
    fecha_inicio_instruc DATETIME  default now(),
...
create table juicio(
    ...
    fecha_inicio_juicio DATETIME default now(),
